...
Project-specific acceptance focus: Reconcile usage and invoices, test forecast assumptions, required retention, queryability after archive, export completeness, duplicate/lost data, approval and rollback, savings attribution, and protected security tables.
